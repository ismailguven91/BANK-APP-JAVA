...
public class Bank {
    ...
    public void bankDeposit(long personalNo, int indexNum, int num){
        for (var item: customers){
            if (personalNo == item.getCostumerPersonalNo()){
    ...
    public void bankWithdraw(long personalNo, int indexNum, int num){
        for (var item: customers){
            if (personalNo == item.getCostumerPersonalNo()){
    ...
    public void bankBalance(long personalNo){
        for (var item: customers){
            if (personalNo == item.getCostumerPersonalNo()){
