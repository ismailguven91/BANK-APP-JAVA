...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        b1.addCustomer(new Customer("Michael Jordan", 9102212222L));
        b1.addAccount(9102212222L);
        b1.addAccount(9102212222L);
        b1.addAccount(9102212222L);

        b1.addCustomer(new Customer("Bill Clinton", 8701213333L));
        ...
        b1.removeAccount(2, 9102212222L);
        System.out.println("Accounts left:" + b1.getCostumerAccounts(9102212222L));
...
//STUDERA KODEN
//OPTIMERA KODEN
// ALLA ACCOUNTS SYNS NÄR MAN VILL TA BORT, VARFÖR? - JAG FÖRSTÅR FORTFARANDE INTE VARFÖR DEN PRINTAR 3 GÅNGER.